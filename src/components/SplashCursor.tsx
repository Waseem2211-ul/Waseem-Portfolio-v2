...
export default function SplashCursor({
  ...
  useEffect(() => {
    ...
    function getWebGLContext(canvasElement: HTMLCanvasElement) {
      ...
      let glContext = canvasElement.getContext('webgl2', params) as any;
      ...
      if (isWebGL2) {
        formatRGBA = getSupportedFormat(glContext, glContext.RGBA16F, glContext.RGBA, halfFloatTexType, supportLinearFiltering);
        formatRG = getSupportedFormat(glContext, glContext.RG16F, glContext.RG, halfFloatTexType, supportLinearFiltering);
        formatR = getSupportedFormat(glContext, glContext.R16F, glContext.RED, halfFloatTexType, supportLinearFiltering);
      } else {
        formatRGBA = getSupportedFormat(glContext, glContext.RGBA, glContext.RGBA, halfFloatTexType, supportLinearFiltering);
        formatRG = getSupportedFormat(glContext, glContext.RGBA, glContext.RGBA, halfFloatTexType, supportLinearFiltering);
        formatR = getSupportedFormat(glContext, glContext.RGBA, glContext.RGBA, halfFloatTexType, supportLinearFiltering);
      }
    ...
    function getSupportedFormat(glContext: any, internalFormat: any, format: any, type: any, supportLinearFiltering: any) {
      if (!supportRenderTextureFormat(glContext, internalFormat, format, type)) {
        switch (internalFormat) {
          case glContext.R16F:
            return getSupportedFormat(glContext, glContext.RG16F, glContext.RG, type, supportLinearFiltering);
          case glContext.RG16F:
            return getSupportedFormat(glContext, glContext.RGBA16F, glContext.RGBA, type, supportLinearFiltering);
          default:
            return null;
        }
      }
